...
namespace MySqlConnector.Core
{
		internal sealed class SchemaProvider
		{
				...
				public DataTable GetSchema(string collectionName, string[] args)
				{
						if (!m_schemaCollections2.TryGetValue(collectionName, out var fillAction))
								throw new ArgumentException("Invalid collection name.", collectionName);

						var dataTable = new DataTable(collectionName);
						fillAction(dataTable, args);
						return dataTable;
				}
				...
				private void FillTables(DataTable dataTable, string[] args = null)
				{
						...
						using (var command = m_connection.CreateCommand())
						{
								...
								for (int i = 0; i < args.Length; i++)
								{
										...
										case 2:
												...
												break;
										case 3:
												command.CommandText += " and TABLE_TYPE='" + args[i] + "'";
												break;
										default:
												break;
										}
				...
				private void FillColumns(DataTable dataTable, string[] args = null)
				{
				...
				private void FillForeignKeys(DataTable dataTable, string[] args = null)
				{
						...
						using (var command = m_connection.CreateCommand())
						{
								...
								for (int i = 0; i < args.Length; i++)
								{
										...
										case 2:
												...
												break;
										case 3:
												command.CommandText += " and CONSTRAINT_NAME='" + args[i] + "'";
												break;
										default:
												break;
										}
				...
				private void FillIndexColumns(DataTable dataTable, string[] args = null)
				{
				...
				private void FillIndexes(DataTable dataTable, string[] args = null)
				{
				...
				readonly Dictionary<string, Action<DataTable, string[]>> m_schemaCollections2;
		}
}
#endif
